 ...
 * });
 */
export function useFetchBoardsCountQuery(
  baseOptions?: Apollo.QueryHookOptions<
    FetchBoardsCountQuery,
    FetchBoardsCountQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FetchBoardsCountQuery, FetchBoardsCountQueryVariables>(
    FetchBoardsCountDocument,
    options
  );
}
export function useFetchBoardsCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    FetchBoardsCountQuery,
    FetchBoardsCountQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    FetchBoardsCountQuery,
    FetchBoardsCountQueryVariables
  >(FetchBoardsCountDocument, options);
}
export function useFetchBoardsCountSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        FetchBoardsCountQuery,
...
export type FetchBoardsCountQueryHookResult = ReturnType<
  typeof useFetchBoardsCountQuery
>;
export type FetchBoardsCountLazyQueryHookResult = ReturnType<
  typeof useFetchBoardsCountLazyQuery
>;
export type FetchBoardsCountSuspenseQueryHookResult = ReturnType<
  typeof useFetchBoardsCountSuspenseQuery
>;
export type FetchBoardsCountQueryResult = Apollo.QueryResult<
  FetchBoardsCountQuery,
  FetchBoardsCountQueryVariables
>;
